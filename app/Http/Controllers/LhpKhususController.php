...
class LhpKhususController extends Controller
{
    public function index(Request $request)
    {
        if($request->has('cari'))
        {
            $data_lhp = Lhp::where('jenis_monitor','LIKE','%'.$request->cari.'%')->get();
        }
       ...
       // dd($data_lhp);
    	...
    	return view('lhp-rutin.index',['data_lhp' => $data_lhp,'data_bagian'=>$data_bagian]);
    }
    ...
    public function edit($id)
    {
        ...
        $lhp = Lhp::find($id);
        return view('lhp-rutin.edit',['lhp' => $lhp, 'data_bagian'=>$data_bagian]);
    }
    ...
    {
        $data_lhp = Lhp::all();
        return view('lhp-rutin.no_lhp',['data_lhp' => $data_lhp]);
    }

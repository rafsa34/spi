...
@section('modal')
<!--buttonmodal-->
<a href="/lhp-khusus/add" type="button" class="btn btn-primary btn-icon-text mb-2 mb-md-0">
        ...
        <form action="/lhp/create" method="POST">
          ...
          <div class="form-group">
            <div class="form-group{{$errors->has('tgl_pemeriksaan') ? ' has-error' : ''}}">
              ...
              <input name="tgl_pemeriksaan" type="date" class="form-control" id="exampleInputEmail1" placeholder="Kode Bagian" value="{{old('tgl_pemeriksaan')}}">
          ...
          <div class="form-group">
            <div class="form-group{{$errors->has('file') ? ' has-error' : ''}}">
              ...
              <input name="file" type="file" class="form-control" id="exampleInputEmail1" placeholder="No Surat Penegasan" value="{{old('no_surat_penegasan')}}">
              @if($errors->has('file'))
